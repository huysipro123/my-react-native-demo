...
const ModalAdd = (props) => {
    ...
    const [imageUrl, setImageUrl] = useState('https://reactjs.org/logo-og.png')
    const [promoType, setPromoType] = useState('price-value')   //0: value - 1: percent
    ...
    const handleSubmitAdd = () => {
        ...
        let productAdd = {
            id: (new Date()).getTime(),
            number: props.getCurrentNumberProduct(),
            img: imageUrl,
            name: nameText,
        ...
        props.handleSubmitAdd(productAdd)
    }
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"}>
            <View style={styles.viewContainer}>
                ...
                >
                    <TouchableWithoutFeedback onPress={() => console.log('TouchableWithoutFeedback Pressssssssss')}>
                        <View style={styles.centeredView}>
                            <View style={styles.modalView}>
                                ...
                                <Text style={[styles.modalTitle, { flex: 2 }]}>Thêm mới sản phẩm</Text>
                                ...
                                <TouchableOpacity style={[styles.btnSubmit, { flex: 2 }]} onPress={handleSubmitAdd}>
